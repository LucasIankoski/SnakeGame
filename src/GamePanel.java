...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void score(Graphics g) {
		...
		FontMetrics fontm = getFontMetrics(g.getFont());
		g.drawString("Score: " + fruitsEaten, (SCREEN_WIDTH - fontm.stringWidth("Score: " + fruitsEaten)) / 2,
				g.getFont().getSize());
	...
	public void gameOver(Graphics g) {
		...
		FontMetrics fontm = getFontMetrics(g.getFont());
		g.drawString("Game Over", (SCREEN_WIDTH - fontm.stringWidth("Game Over")) / 2, SCREEN_HEIGHT / 2);
	}
